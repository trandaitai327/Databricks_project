...
# MAGIC %md
# MAGIC # Bronze Layer: Ingest Order Items Data
...
source_path = "/FileStore/datasets/olist_order_items_dataset.csv"
target_table = f"{bronze_schema}.order_items"
...
df_bronze = df_raw \
    ...
    .withColumn("source_file", lit("olist_order_items_dataset.csv")) \
