...
# MAGIC %md
# MAGIC # Bronze Layer: Ingest Customers Data
...
source_path = "/FileStore/datasets/olist_customers_dataset.csv"
target_table = f"{bronze_schema}.customers"
...
df_bronze = df_raw \
    ...
    .withColumn("source_file", lit("olist_customers_dataset.csv")) \
