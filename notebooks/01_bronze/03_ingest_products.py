...
# MAGIC %md
# MAGIC # Bronze Layer: Ingest Products Data
...
source_path = "/FileStore/datasets/olist_products_dataset.csv"
target_table = f"{bronze_schema}.products"
...
df_bronze = df_raw \
    ...
    .withColumn("source_file", lit("olist_products_dataset.csv")) \
