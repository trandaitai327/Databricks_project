...
# MAGIC %md
# MAGIC # Bronze Layer: Ingest Order Reviews Data
...
source_path = "/FileStore/datasets/olist_order_reviews_dataset.csv"
target_table = f"{bronze_schema}.order_reviews"
...
df_bronze = df_raw \
    ...
    .withColumn("source_file", lit("olist_order_reviews_dataset.csv")) \
