...
# MAGIC %md
# MAGIC # Bronze Layer: Ingest Order Payments Data
...
source_path = "/FileStore/datasets/olist_order_payments_dataset.csv"
target_table = f"{bronze_schema}.order_payments"
...
df_bronze = df_raw \
    ...
    .withColumn("source_file", lit("olist_order_payments_dataset.csv")) \
