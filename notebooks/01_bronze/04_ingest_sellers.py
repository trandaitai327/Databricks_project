...
# MAGIC %md
# MAGIC # Bronze Layer: Ingest Sellers Data
...
source_path = "/FileStore/datasets/olist_sellers_dataset.csv"
target_table = f"{bronze_schema}.sellers"
...
df_bronze = df_raw \
    ...
    .withColumn("source_file", lit("olist_sellers_dataset.csv")) \
